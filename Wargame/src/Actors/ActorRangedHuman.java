...
public class ActorRangedHuman extends Actor {
    private static final int side = 0;
    private static String[] charName = {"Archer"};
    private static String[][] charWep = {{"Long Bow", "Cross Bow"}};
    ...
    public ActorRangedHuman(int id, int wep) {
        this.id = id;
        getCharHP();
        getCharAp();
        getCharAtt();
